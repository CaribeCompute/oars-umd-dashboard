...
2. Register a landowner and confirm email; access should not require approval after applying the registration-policy migration. Verify an Extension Officer remains pending until approved. See [account setup](account-registration-guide.md).
