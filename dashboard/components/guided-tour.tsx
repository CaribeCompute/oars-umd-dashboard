...
export function GuidedTour(){
 ...
 function start(){const content=document.querySelector('[aria-label="Interactive OARS property map"]')?gis:document.querySelector('[data-tour="assessment"]')?assessment:dashboard;setSteps([intro,...content]);setIndex(0);setOpen(true);}
