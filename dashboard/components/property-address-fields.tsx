...
export function PropertyAddressFields() {
  ...
  const update = (key: keyof PropertyAddress, value: string) => setAddress(previous => ({ ...previous, [key]: value }));
