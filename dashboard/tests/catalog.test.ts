...
test('catalog snapshot preserves source coverage, exclusions and unknown stages', () => {
...
test('catalog uses hyperlink targets and preserves county-specific entries', () => {
