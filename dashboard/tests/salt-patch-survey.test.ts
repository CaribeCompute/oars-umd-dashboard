...
test('handoff preserves exact pin and encoded text using actual Survey123 field identifiers', () => {
...
test('handoff refuses flooding, invalid pins, blank required fields and oversized notes', () => {
