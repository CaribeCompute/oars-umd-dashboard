...
void test('program validation rejects unsafe links, invalid visibility, and incomplete entries',()=>{
...
void test('contributor entries retain provider details without claiming workbook shortlisting',()=>{
...
void test('every catalog detail and resource survives contributor validation and display',async()=>{
...
void test('older contributor records retain existing fields while new optional fields default blank',()=>{
