        ...
        <section className="relative mx-auto grid min-h-[720px] max-w-[1400px] items-center gap-14 px-5 pb-20 pt-36 lg:grid-cols-[1.05fr_.95fr] lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-sm text-white/55">
              Landowners can sign in after email verification. Agency and Extension Officer accounts also require administrator approval. Administrators join by invitation.
            </p>
          </div>
          ...
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-center">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-base leading-7 text-white/68">
                ...
                Landowners can sign in after email verification. Agency and Extension Officer registrations require administrator approval; administrators join by invitation.
              </p>
            </div>
            <Button
              size="lg"
  ...
  if (submitted) return (
    <main className="grid min-h-screen place-items-center bg-[var(--mist)] px-5">
      <section className="max-w-xl rounded-[28px] border bg-white p-9 text-center shadow-lg">
        ...
        <p className="mt-4 text-base leading-7 text-muted-foreground">{accountType === 'landowner' ? 'Verify your email, then sign in. Landowner accounts do not require administrator approval.' : 'Verify your email. An administrator must approve your account before you can access your workspace.'}</p>
    ...
    <main className="min-h-screen bg-[var(--mist)]">
      <div className="mx-auto max-w-4xl px-5 py-10 lg:py-14">
        ...
        <div className="rounded-[30px] border bg-white p-6 shadow-sm sm:p-10">
          ...
          <p className="mt-3 max-w-2xl text-base leading-7 text-muted-foreground">Landowners can sign in after email verification. Agencies and Extension Officers must also be approved by an administrator. Administrator accounts are created through an existing administrator’s invitation.</p>
